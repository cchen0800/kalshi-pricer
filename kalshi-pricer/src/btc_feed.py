...
across Bitstamp, Kraken, and Gemini — three of the six exchanges in the BRTI
basket. Median across multiple constituents tracks BRTI more closely than any
...
# Spot-fallback constituents — all BRTI basket members, all with public
# unauthenticated last/bid/ask endpoints.
