...
CREATE TABLE IF NOT EXISTS intended_orders (
    ...
    raw_response        TEXT,
    bot_id              TEXT                         -- e.g. 'eth-selective', 'eth-aggressive'
);
...
-- Note: a `settlements` table already exists in pricer.db for historical ETH
...
-- expiration_value is the actual final ERTI print Kalshi resolved against,
...
CREATE TABLE IF NOT EXISTS market_settlements (
    ...
    expiration_value         REAL,                   -- final ERTI dollars
    volume                   REAL,
    open_interest            REAL,
    raw_response             TEXT
);
