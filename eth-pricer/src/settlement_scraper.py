"""Periodic scrape of ground-truth resolution for *every* settled KXETHD market.
...
Once a market is finalized at Kalshi the response includes:
    ...
    expiration_value: the ERTI close print (string $ value) — the cleanest
...
def _recent_closed_events(kc: KalshiClient, series: str, lookback: timedelta) -> list[str]:
    ...
    itself — KXETHD-YYMMMDDHH encodes the close hour deterministically."""
