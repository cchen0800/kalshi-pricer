    ...
    *,
    ...
    db.execute(
        ...
        (
            ...
            "KXETHD-26MAY1315-T2250", side, action,
            limit_price_cents, 10, limit_price_cents / 10.0, 0.267, None, 5.3, 51.0, 2_244.0,
...
def test_sync_sibling_bot_dbs_updates_matched_sibling_fills(tmp_path):
    root = tmp_path
    current_dir = root / "eth-pricer"
    sibling_dir = root / "sol-pricer"
    current_dir.mkdir()
    sibling_dir.mkdir()
