"""One-shot: verify Kalshi auth works and inspect KXETHD market metadata.

Goal: confirm what Kalshi settles ETH markets against (Coinbase? a CF index?)
so we know which spot source to track in eth_feed.py.
"""
