"""Fetch Coinbase ETH-USD 1m candles around each event close → cache settlement prices.

For each KXETHD-YYMMMDDHH event, Kalshi settles against the ERTI averaged over
