    ...
    *,
    ...
    db.execute(
        ...
        (
            ...
            "KXSOLD-26MAY1315-T91.9999", side, action,
            limit_price_cents, 10, limit_price_cents / 10.0, 0.267, None, 5.3, 51.0, 91.4,
...
def test_fill_sync_notifies_new_matched_fill_once(db):
    ...
    fill = {
        "trade_id": "trade-1",
        "order_id": "order-1",
        "ticker": "KXSOLD-26MAY1315-T91.9999",
        "side": "no",
        "action": "buy",
        "count": 10,
