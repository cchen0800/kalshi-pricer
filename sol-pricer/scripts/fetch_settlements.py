"""Fetch Coinbase SOL-USD 1m candles around each event close → cache settlement prices.

For each KXSOLD-YYMMMDDHH event, Kalshi settles against the SRTI averaged over
