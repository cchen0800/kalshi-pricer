"""One-shot: verify Kalshi auth works and inspect KXBTCD market metadata.

Goal: confirm what Kalshi settles BTC hourly markets against (Coinbase? a CF index?)
so we know which spot source to track in btc_feed.py.
"""
